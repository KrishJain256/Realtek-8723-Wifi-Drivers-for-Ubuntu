...
__used __section("__versions") = {
	...
	{ 0x3e90f5d4, "rtl8723ae_firmware_selfreset" },
	...
	{ 0x47b25d4f, "rtl8723_phy_pi_mode_switch" },
	...
	{ 0x56e2cde2, "rtl8723_phy_txpwr_idx_to_dbm" },
...
MODULE_INFO(depends, "rtlwifi,rtl8723-common,rtl_pci,btcoexist");

MODULE_ALIAS("pci:v000010ECd00008723sv*sd*bc*sc*i*");

MODULE_INFO(srcversion, "ACCCB15642DEFC668BCB0CE");
